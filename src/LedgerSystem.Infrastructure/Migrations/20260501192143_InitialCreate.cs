...
namespace LedgerSystem.Infrastructure.Migrations
{
    /// <inheritdoc />
        ...
        .Annotation("Npgsql:PostgresExtension:pgcrypto", ",,");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
                    expires_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW() + INTERVAL '24 hours'")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_transfers_different_wallets", "source_wallet_id != destination_wallet_id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ledger_entries_transfer_id",
                table: "ledger_entries",
                column: "transfer_id");
